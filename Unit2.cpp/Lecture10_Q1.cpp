...
int main() {
    string acc1Number, acc2Number;
    double acc1Balance, acc2Balance, depositAmount, withdrawAmount;

    // Input for account 1
    cin >> acc1Number >> acc1Balance;
    cin.ignore(); // Ignore newline character

    // Input for account 2
    cin >> acc2Number >> acc2Balance;
    cin.ignore(); // Ignore newline character

    // Create bank accounts
    BankAccount account1(acc1Number, acc1Balance);
    BankAccount account2(acc2Number, acc2Balance);
    ...
    // Try to withdraw from account 2
